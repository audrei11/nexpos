      ...
      <Header
        ...
        actions={
          <div className="flex items-center gap-2">
            ...
            <button
              onClick={() => toast.success('Restock order placed!')}
          ...
          <table className="w-full">
            <thead>
              <tr className="border-b border-surface-100 bg-surface-50/50">
                ...
                <th className="px-4 py-3 w-24 text-right text-xs font-semibold text-surface-500 uppercase tracking-wider">Action</th>
              </tr>
            </thead>
                  ...
                  <tr key={product.id} className="hover:bg-surface-50/50 transition-colors">
                    <td className="px-6 py-3.5">
                      <div className="flex items-center gap-3">
                        <div className="flex h-9 w-9 items-center justify-center rounded-xl bg-surface-50 text-xl">
                          {product.emoji}
                        </div>
                        <div>
                    ...
                    <td className="px-4 py-3.5 text-right">
                      {(isOut || isLow) && (
                        <button
                          onClick={() => toast.success(`Restock order created for ${product.name}`)}
                          className="flex items-center gap-1 rounded-lg bg-brand-50 px-2.5 py-1 text-xs font-semibold text-brand-600 hover:bg-brand-100 transition-all ml-auto"
                        >
